...
export const { chooseName, choosePrice, chooseDescription, chooseCam, chooseFlight, chooseSpeed, chooseCost, chooseSeries, chooseWeight, chooseDim } = rootSlice.actions;